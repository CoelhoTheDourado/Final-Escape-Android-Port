...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	MusicianName1 = 'Pinky Micheal'
	MusicianName2 = 'DefNotDylan'
	MusicianName3 = 'DanlyDaMusicant'

	CharterName1 = 'Pinky Michael'
	CharterName2 = 'IconsGuy'

	ConceptName1 = 'RightBurst Ultra'
	ConceptName2 = 'MarStarBro'
...
function onCreate()
	...
	function onStepHit()
		...
		if curStep == Start then
			...
			doTweenY('CONCEPT1', 'CONCEPT', 540, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CONCEPT1', 'CONCEPT1', 500, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CONCEPT2', 'CONCEPT2', 530, TweenSpeed/1.6, 'QuadOut')
			doTweenY('CONCEPT3', 'CONCEPT3', 560, TweenSpeed/1.6, 'QuadOut')
